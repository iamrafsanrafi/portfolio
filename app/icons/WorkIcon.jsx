const WorkIcon = ({width = 25, height = 25}) => {
    return (
        <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width={width} height={height} x="0" y="0" version="1.1" viewBox="0 0 512 512">
